  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link pt-10 text-white" href="homePage.php"><i class="fas fa-home"></i>&nbsp;&nbsp;Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="contacts.php"><i class="fas fa-address-book"></i>&nbsp;&nbsp;Contacts</a>
      </li>
     </ul>
  </div>
</nav>
