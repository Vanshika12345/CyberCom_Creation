...
if (isset( $_POST['firstname']) && isset($_POST['password']) && isset($_POST['address']) && isset( $_POST['game']) && isset($_POST['gender']) && isset($_POST['month']) && isset($_POST['year']) && isset($_POST['day']) && isset($_POST['marital_status']) && isset($_POST['accept'])) {
		...
		//
		if($name != '' && $password != '' && $address != ''&& $month != 'month' && $day !== 'day' && $year !== 'year' && $game != '' && $gender != '' && $marital_status != ''){

			if ($conn) {
	 		$query = "insert into user_form_two(name,password,address,game,gender,date_of_birth,marital_status) values('$name','$password','$address','$games_arr','$gender','$dob','$marital_status')";
