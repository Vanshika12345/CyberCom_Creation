        ...
        if (!empty($title) && !empty($content) && !empty($url) && !empty($category) && !empty($image) && !empty($published)) {
                $location = 'uploads/';
                 if (move_uploaded_file($tmpName, $location.$name)) {
                             insertPost($title, $content, $url, $category, $published);
...
<div class="container m-5">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype ='multipart/form-data'>
                    ...
                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="ppublishedAt" id="ppublishedAt" class="form-control" >
    ...
    <script type="text/javascript" src="js/addBlogs_js.js"></script>
</body>
</html>